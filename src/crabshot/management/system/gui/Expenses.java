...
public class Expenses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        expensesDataTable = new javax.swing.JTable();
        ...
        jLabel2.setBounds(560, 140, 260, 70);

        expensesDataTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "S.no", "Name", "Rate", "Discription"
            }
        ));
        expensesDataTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                expensesDataTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(expensesDataTable);
        ...
        expensesDate.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                expensesDatePropertyChange(evt);
            }
        });
        getContentPane().add(expensesDate);
        expensesDate.setBounds(490, 200, 320, 30);
    ...
    String name="";
    private void expensesDataTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_expensesDataTableMouseClicked
        // TODO add your handling code here:
             name = this.expensesDataTable.getValueAt(expensesDataTable.getSelectedRow(), 1).toString();
   
    }//GEN-LAST:event_expensesDataTableMouseClicked
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        // TODO add your handling code here:
        int row=expensesDataTable.getSelectedRow();
        if(row==-1){
            JOptionPane.showMessageDialog(null,"Please select the Record for Update..!");
        }
        else{
            expensesName=this.expensesDataTable.getValueAt(row, 1).toString();
          //  System.out.println("COntact number is : "+contactNo);
            ExpensesUpdate expensesUpdate=new ExpensesUpdate();
            expensesUpdate.setVisible(true);
            setVisible(false);
        }
    ...
    private void expensesDatePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_expensesDatePropertyChange
        // TODO add your handling code here:
        try{
           // SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
           // String d = sdf.format(orderDate.getDate());
            int count=0;
            if(expensesDate.getDate()==null){
            
            }
            else{
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                String d = sdf.format(expensesDate.getDate());
                ResultSet result=DBManager.SearchExpensesByDate(d);
                
                defaultTableModel = buildTableModel(result);
                this.expensesDataTable.removeAll();
                this.expensesDataTable.setModel(defaultTableModel);
            }
        }catch(Exception e){
            e.printStackTrace();
        }
    }//GEN-LAST:event_expensesDatePropertyChange
    ...
    private javax.swing.JTable expensesDataTable;
