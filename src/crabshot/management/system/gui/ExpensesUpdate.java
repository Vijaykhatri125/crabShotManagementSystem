 ...
 * @author Shahzeb Shah
 */
public class ExpensesUpdate extends javax.swing.JFrame {

    /**
     * Creates new form ProductsUpdate
     */
    String name="";
    public ExpensesUpdate() {
        initComponents();
        setBounds(0, 0, 1315, 735);
        name=Expenses.expensesName;
    ...
    private void initComponents() {
        ...
        submitButton.setBounds(550, 440, 130, 40);
        ...
        cancelButton.setBounds(690, 440, 130, 40);
        ...
        try{
            ...
            if(name.equals("")){
                ...
                if(price.matches("[0-9]*")){
                    int id=DBManager.getExpensesIdByName(name);
                    int rate=Integer.parseInt(this.rateField.getText());
                    boolean status=DBManager.updateExpenses(name, rate, discripition, date,id);
                    if(status==true){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpensesUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExpensesUpdate().setVisible(true);
            }
        });
    }
    ...
    private void showRecord(String name) {
        try{
            ResultSet result=DBManager.getSearchedExpensesRecord(name);
            while(result.next()){
                this.nameField.setText(result.getString("name"));
                this.rateField.setText(result.getString("amount"));
                this.discripitionField.setText(result.getString("description"));
            }
        }catch(Exception e){
            e.printStackTrace();
        }
