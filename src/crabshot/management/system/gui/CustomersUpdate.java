 ...
 * @author Shahzeb Shah
 */
public class CustomersUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(450, 190, 400, 40);
        ...
        addressLabel.setBounds(410, 360, 124, 40);

        addressField.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(addressField);
        addressField.setBounds(550, 360, 330, 40);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        String contactNo=this.contactField.getText();
        ...
        if(name.equals("")){
           ...
           // System.out.println("hello - else");
            int id=DBManager.getCustomerId(contactNumber);
            //System.out.println("id is : "+id);
            boolean status=DBManager.updateCustomer(name, contactNo, address, id);
            if(status==true){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomersUpdate().setVisible(true);
            }
        });
    }
    ...
    private void showRecord(String contactNumber) {
        try{
            ResultSet result=DBManager.getSearchedRecord(contactNumber);
            while(result.next()){
                this.nameField.setText(result.getString("name"));
                this.contactField.setText(result.getString("contactno"));
                this.addressField.setText(result.getString("address"));
            }
        }catch(Exception e){
            e.printStackTrace();
        }
